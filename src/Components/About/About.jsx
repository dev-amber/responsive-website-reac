...
const About = ({setPlayState}) => {
  return (
    <div className='about'>
      ...
      <p>whether you aspire to become ateacher ,administator, counselor ,or educational leader, our diverse range of programs offers the prefect pathway to acheive your goals and unlock your full potenial in shaping the future of education.</p>
      </div>
